                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="mb-3 row align-items-center">
                            ...
                            <div class="col">
                                <input type="text" class="form-control-plaintext" name="email" placeholder="Email" value="{{ $user->email }}" readonly>
                            </div>
                        </div>
                        <div class="mb-3 row align-items-center">
                            <label class="col-sm-2 form-label">Nama</label>
                            <div class="col">
                                <input type="text" class="form-control" name="nama" placeholder="Admin name" value="{{ $user->nama }}">
                            </div>    
                        </div>
                        <div class="mb-3 row align-items-center">
